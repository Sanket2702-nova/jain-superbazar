...
const CategoryCard = ({ id, name, image }) => {
  return (
    ...
    >
      ...
      <h3 className="text-xs md:text-sm font-bold text-center text-gray-800 dark:text-gray-200 leading-tight transition-colors duration-300 group-hover:text-primary">
        {name}
      </h3>
      {/* Underline on hover */}
